                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-4 text-left">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-black/40 border border-amber-500/10 focus:border-amber-500/40 rounded-xl text-white text-sm outline-none transition-all placeholder:text-neutral-600"
                        />
                    </div>
